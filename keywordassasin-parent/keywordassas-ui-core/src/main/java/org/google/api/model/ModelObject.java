...
public class ModelObject implements Comparable<ModelObject>{
	...
	public String toString() {
		return "ModelObject [keyword=" + keyword
				+ ", realNumberOfCompetitivePages="
				+ realNumberOfCompetitivePages + ", competitionStrength="
				+ competitionStrength + ", averagePageRank=" + averagePageRank
				+ ", pageRankStrentgh=" + pageRankStrentgh
				+ ", adwordCompetition=" + adwordCompetition
				+ ", localMonthlySearches=" + localMonthlySearches
				+ ", globalMonthlySearches=" + globalMonthlySearches + ", cpc="
				+ cpc + ", commercialIntent="
				+ commercialIntent + ", adsCount=" + adsCount
				+ ", keywordRating=" + keywordRating + "]";
	}
	public String outputModel(){
		return keyword
				+ "," + marshallNullValue(localMonthlySearches)
				+ "," + marshallNullValue(cpc)
				+ "," + marshallNullValue(totalNumberOfCompetitivePages)
				+ "," + marshallNullValue(realNumberOfCompetitivePages)
				+ "," + marshallNullValue(competitivePageStrength)
				+ "," + marshallNullValue(averagePageRank)
				+ "," + marshallNullValue(pageRankStrentgh)
				+ "," + marshallNullValue(competitionStrength) 
				+ "," + marshallNullValue(commercialIntent)
				+ "," + marshallNullValue(adsCount)
